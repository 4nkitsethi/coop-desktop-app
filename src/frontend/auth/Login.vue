          ...
          <form @submit.prevent="authenticate()" method="post">
            <ul class="">
              <li class="mb--2">
                ...
                <input v-model="credentials.email"  class="inputStyle keyboard-alpha" placeholder="Enter user name ... " />              
              </li>
              <li class="mb--2">
                <h6 class="Text--Left mb--1">Password</h6>
                <input v-model="credentials.password" class="inputStyle  keyboard-alpha" placeholder="Enter password" type="password"/>              
              </li>
              <li class="">
